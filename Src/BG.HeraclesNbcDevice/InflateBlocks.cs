...
// Type: HeraclesNbcDevice.InflateBlocks
    ...
    while (true)
    {
      ...
      switch (this.mode)
      {
        ...
        case InflateBlocks.InflateBlockMode.TABLE:
          ...
          {
            int length = 258 + (num10 & 31 /*0x1F*/) + (num10 >> 5 & 31 /*0x1F*/);
          ...
          while (true)
          {
            ...
            if (this.index < 258 + (table1 & 31 /*0x1F*/) + (table1 >> 5 & 31 /*0x1F*/))
            {
              ...
              else
              {
                ...
                if (index3 + num14 <= 258 + (table2 & 31 /*0x1F*/) + (table2 >> 5 & 31 /*0x1F*/) && (huft2 != 16 /*0x10*/ || index3 >= 1))
                {
